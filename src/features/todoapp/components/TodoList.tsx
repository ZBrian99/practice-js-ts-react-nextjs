...
import { FiltersType, Todo } from '@/features/todoapp/type/todoTypes';
...
export const TodoList = () => {
	...
	const handleDeleteTodo = useCallback((todoId: string) => {
		if (confirm('¿Estás seguro de que quiere eliminar esta tarea?')) {
	...
	return (
		<div className='flex flex-col gap-4 h-full'>
			<section
				...
				className={`flex flex-col overflow-y-auto h-[calc(100vh-4rem)] p-4 transition-all duration-300 ${
					uiState.isTodoView
