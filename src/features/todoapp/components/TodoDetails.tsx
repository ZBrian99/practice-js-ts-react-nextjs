...
const TodoDetail = memo(({ todo, isOpen, onClose }: TodoDetailProps) => {
	...
	if (!todo) {
		return (
			<section
				className={`fixed top-16 right-0 bg-gray-900 sm:border-l border-t border-gray-600 w-full sm:w-xl 2xl:w-4xl h-[calc(100svh-4rem)] transition-all duration-300 ease-in-out overflow-y-auto flex flex-col z-50 ${
			...
			<div className='p-4 pb-0'>
				<div className='flex items-center gap-4 mb-4'>
					...
					<div className='flex items-center gap-3 ml-auto'>
						...
						{onClose && (
							<>
								<div className='w-px h-6 bg-gray-600 lg:hidden'></div>
								<button
									onClick={onClose}
				...
				<div className='h-px bg-gray-700/30 mb-4'></div>
